...
from ...schemas.analytics import DashboardQuerySchema
...
def parse_query_params():
    ...
    try:
        ...
        if start_date_str:
            try:
                query_params["start_date"] = datetime.fromisoformat(
        ...
        if end_date_str:
            try:
                query_params["end_date"] = datetime.fromisoformat(
...
def get_system_overview():
    ...
    try:
        ...
        return standardized_response(
            data=overview_data, message="System overview retrieved successfully"
        )
    except Exception as e:
        return standardized_response(
            success=False,
            message=f"Error retrieving system overview: {e!s}",
            status_code=500,
        )
...
def get_endpoints_summary():
    ...
    try:
        ...
        return standardized_response(
            data=endpoints_data, message="Endpoints summary retrieved successfully"
        )
    except Exception as e:
        return standardized_response(
            success=False,
            message=f"Error retrieving endpoints summary: {e!s}",
            status_code=500,
        )
...
def get_requests_by_period():
    ...
    try:
        ...
        return standardized_response(
            data=period_data, message="Request count by period retrieved successfully"
        )
    except Exception as e:
        return standardized_response(
            success=False,
            message=f"Error retrieving request count by period: {e!s}",
            status_code=500,
        )
...
def get_status_code_distribution():
    ...
    try:
        ...
        return standardized_response(
            data=status_data, message="Status code distribution retrieved successfully"
        )
    except Exception as e:
        return standardized_response(
            success=False,
            message=f"Error retrieving status code distribution: {e!s}",
            status_code=500,
        )
...
def get_top_source_ips():
    ...
    try:
        ...
        return standardized_response(
            data=ip_data, message="Top source IPs retrieved successfully"
        )
    except Exception as e:
        return standardized_response(
            success=False,
            message=f"Error retrieving top source IPs: {e!s}",
            status_code=500,
        )
...
def get_response_time_analytics():
    ...
    try:
        ...
        return standardized_response(
            success=False,
            message=f"Error retrieving response time analytics: {e!s}",
            status_code=500,
        )
